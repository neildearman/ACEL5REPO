...
| Ethernet7 | P2P_LINK_TO_BORDERLEAF1_Ethernet5 | routed | - | 10.10.1.36/31 | default | 1550 | False | - | - |
| Ethernet8 | P2P_LINK_TO_BORDERLEAF2_Ethernet5 | routed | - | 10.10.1.44/31 | default | 1550 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 172.16.0.109/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 10.10.1.5 | 65201 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.10.1.13 | 65201 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.10.1.21 | 65202 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.10.1.29 | 65203 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.10.1.37 | 65500 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.10.1.45 | 65500 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65200
   ...
   neighbor 10.10.1.5 remote-as 65201
   neighbor 10.10.1.5 description leaf1_Ethernet5
   neighbor 10.10.1.13 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.10.1.13 remote-as 65201
   neighbor 10.10.1.13 description leaf2_Ethernet5
   neighbor 10.10.1.21 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.10.1.21 remote-as 65202
   neighbor 10.10.1.21 description leaf3_Ethernet5
   neighbor 10.10.1.29 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.10.1.29 remote-as 65203
   neighbor 10.10.1.29 description leaf4_Ethernet5
   neighbor 10.10.1.37 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.10.1.37 remote-as 65500
   neighbor 10.10.1.37 description borderleaf1_Ethernet5
   neighbor 10.10.1.45 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.10.1.45 remote-as 65500
   neighbor 10.10.1.45 description borderleaf2_Ethernet5
